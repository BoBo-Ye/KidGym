...
class Memory_Filling(KidGymTask):
    """
    ## Description
    ...
    def get_info_img(self):
        ...
        target_img = ImgOverlay(ImgZoom(LoadImage(f"{IMG_BASE_PATH}/game/bag_grid.png"), 1.1), ImgZoom(self.target, 0.9), middle_center=True)
